import {
    ...
    ACTION_SET_ARRIVED_STATIONS,
    ACTION_SET_CHECKED_ARRIVED_STATIONS,
...
export default {
    ...
    arrivedStations (state = [], action) {
        const { type, payload } = action;
        switch (type) {
            case ACTION_SET_ARRIVED_STATIONS:
                return payload
            default:
        }
        return state
    },
    checkedArrivedStations (state = {}, action) {
        const { type, payload } = action;
        switch (type) {
            case ACTION_SET_CHECKED_ARRIVED_STATIONS:
                return payload
            default:
        }
        return state
    ...
    searchParse (state = false, action) {
        const { type, payload } = action;
        switch (type) {
            case ACTION_SET_SEARCH_PARSE:
                return payload
            default:
        }
        return state
